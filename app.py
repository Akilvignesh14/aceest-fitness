...
class ACEestApp:
    def __init__(self, root):
        self.root = root
        self.root.title("ACEest Fitness & Performance v2.1.2")
    ...
    def init_db(self):
        # SRE FIX: Use in-memory database for headless tests to avoid file permission errors
    ...
    def setup_ui(self):
        header = tk.Label(
            self.root,
            text="ACEest Functional Fitness System v2.1.2",
            bg="#d4af37",
            fg="black",
